import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as n,c as i,e as s}from"./app-AT5MTRLB.js";const d={},a=s(`<h2 id="build-project" tabindex="-1"><a class="header-anchor" href="#build-project" aria-hidden="true">#</a> <strong>Build Project</strong></h2><p>**构建工程，编译项目 Ctrl + B，**<strong>全局编译</strong>，快速定位错误，快速定位模块中文件错误，当不知道修改了哪一个模块时使用</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>  Compile all modified and dependent files in the project 
